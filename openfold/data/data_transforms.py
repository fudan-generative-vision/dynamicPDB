...
def atom37_to_frames(protein, eps=1e-8):
    ...
    # print(f"all_atom_positions:{all_atom_positions.shape}, residx_rigidgroup_base_atom37_idx:{residx_rigidgroup_base_atom37_idx.shape} no_batch_dims:{len(all_atom_positions.shape[:-2])}")
    # exit()
