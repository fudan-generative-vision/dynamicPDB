...
parser.add_argument('--out_dir_root', type=str, default='./data_dynamic/embeddings')
...
parser.add_argument('--data_csv_path', type=str, default='applications/physics_condition/examples/dynamicPDB.csv')
