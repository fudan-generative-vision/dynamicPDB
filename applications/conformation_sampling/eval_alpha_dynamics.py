...
class Evaluator:
    ...
    def start_evaluation(self):
        ...
        if self._conf.eval.mode==0:
            ...
            ckpt_eval_metrics,curve_fig,curve_fig_aligned,error_fig,model_ckpt_update,rot_trans_error_mean = self.exp.eval_offline_fn(eval_dir,test_loader,self.device,
            ...
            # self.exp.eval_fn_multi_ref(eval_dir,test_loader,self.device,in_diffuser=self.exp._diffuser,exp_name=self._weights_path.split('/')[-3],data_conf=self._data_conf,
            #                     num_workers=self._exp_conf.num_loader_workers,eval_batch_size=self._eval_conf.eval_batch_size,
            #                     noise_scale=self._exp_conf.noise_scale,is_training=False,
            #                     start_idx=self._data_conf.eval_start_idx,end_idx=self._data_conf.eval_end_idx)
