...
class SO3Diffuser:
    ...
    def forward_marginal(self, rot_0: np.ndarray, t: float):
        ...
        #sampled_rots = self.sample(t, n_samples=n_samples)[None].repeat(rot_0.shape[0],axis=0).reshape([rot_0.shape[0]*rot_0.shape[1], 3])
        #print(rot_0.shape, sampled_rots.shape)
        #exit()
