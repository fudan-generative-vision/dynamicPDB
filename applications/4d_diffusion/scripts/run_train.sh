...
--use_env applications/4d_diffusion/train_4d_difffusion.py experiment.num_gpus=${NUM_GPU} experiment.batch_size=${NUM_GPU}  \
...
experiment.base_root=./applications/4d_diffusion/results/train \
